...
ModelOutput = namedtuple('ModelOutput',
                         ['vertices', 'joints', 'transforms',
                          'full_pose', 'betas','global_orient', 'hand_pose'
                          ])
...
class MANO(nn.Module):
    ...
    def forward(self, betas=None, global_orient=None, hand_pose=None, transl=None,
        ...
        if return_verts:
            vertices, joints, transforms = lbs(betas, full_pose, self.v_template,
        ...
        output = ModelOutput(vertices=vertices if return_verts else None,
                             ...
                             transforms=transforms if return_verts else None,
                             betas=betas,
